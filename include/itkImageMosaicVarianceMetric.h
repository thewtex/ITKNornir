...
public:
  ...
  */
  void
  setup_param_map(const std::vector<bool> & params_shared, const std::vector<bool> & params_active);
  ...
  */
  ...
  measure_t
  GetValue(const params_t & parameters) const
  {
    measure_t    measure;
  ...
  void
  GetDerivative(const params_t & parameters, derivative_t & derivative) const
  {
    measure_t measure;
    GetValueAndDerivative(parameters, measure, derivative);
  }
  ...
  void
  GetValueAndDerivative(const params_t & parameters, measure_t & value, derivative_t & derivative) const;
  ...
  variance(measure_t & max_var, measure_t & avg_var) const;

  typename image_t::Pointer
  variance(const typename TImage::SpacingType & sp,
...
#  include "itkImageMosaicVarianceMetric.hxx"
